	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<b>Sistem Informasi Pemungutan Suara Himasifo UPN Veteran Jawa Timur</b>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text font-weight-light"> E - PEMIRA</span>
			</a>
        ...
        ?>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="?page=data-kandidat" class="nav-link">
          ...
          switch ($hal) {
              //Klik Halaman Home Pengguna
				...
				case 'del-pengguna':
					...
					//calon
				case 'data-kandidat':
					include "admin/kandidat/data_kandidat.php";
					break;
				case 'add-kandidat':
					include "admin/kandidat/add_kandidat.php";
					break;
				case 'edit-kandidat':
					include "admin/kandidat/edit_kandidat.php";
					break;
				case 'del-kandidat':
					include "admin/kandidat/del_kandidat.php";
					break;
				...
				case 'dpt-datakandidat':
					include "pemilih/kandidat/data_kandidat.php";
					break;
				case 'dpt-pilihkandidat':
					include "pemilih/kandidat/pilih_kandidat.php";
					break;
				case 'dpt-bukakandidat':
                  include "pemilih/kandidat/buka_kandidat.php";
				  break;
				case 'view-kandidat':
                  include "pemilih/kandidat/view_kandidat.php";
				  break;
				case 'info':
					include "pemilih/kandidat/info.php";
					break;
					
				//Kotak suara
				case 'data-suara':
                  include "admin/perolehansuara/data_suara.php";
                  break;

                //Laporan
                case 'daftar-kandidat':
                	include "admin/laporan/daftarkandidat.php";
                	break;
                case 'daftar-pemilih':
                	include "admin/laporan/daftarpemilih.php";
                	break;
				case 'Grafik':
                	include "admin/laporan/Grafik.php";
                break;
