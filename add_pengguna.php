	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="password" class="form-control" id="password" name="kode_akses" placeholder="Masukkan Kode Akses...">
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_pengguna (npm,nama_pengguna,kode_akses,level,status,jenis) VALUES (
        '".$_POST['npm']."',
        '".$_POST['nama_pengguna']."',
        '".$_POST['kode_akses']."',
        '".$_POST['level']."',
