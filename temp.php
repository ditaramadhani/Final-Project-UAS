		...
		<div class="col-md-4">
			<div class="card card-primary card-outline">
				<div class="card-body">
					...
					<center>
						<a href="?page=view_kandidat&kode=<?php echo $data['id_calon']; ?>" class="btn btn-success btn-sm">
							<i class="fa fa-file"></i> Detail
						</a>
						<a href="?page=pilih_kandidat&kode=<?php echo $data['id_calon']; ?>" class="btn btn-primary">
