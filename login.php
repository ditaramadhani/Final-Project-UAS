...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<img src="dist/img/login.png" width=200px />
			<br>
			<a href="login.php">
				Aplikasi
				<b>E-Voting Pemira</b>
		...
		<div class="card">
			<div class="card-body login-card-body">
				<p class="login-box-msg">Himasifo UPN Veteran Jawa Timur</p>
				...
				<form action="" method="post">
					...
					<div class="input-group mb-3">
						<input type="password" class="form-control" name="kode_akses" placeholder="Masukkan Kode Akses" required>
						<div class="input-group-append">
							<div class="input-group-text">
...
<?php  
	if (isset($_POST['btnLogin'])) {  
		...
		//query login
		$sql_login = "SELECT * FROM tb_pengguna WHERE BINARY npm='$npm' AND kode_akses='$kode_akses'";
		...
		if ($jumlah_login ==1 ){
			...
			$_SESSION["ses_kode_akses"]=$data_login["kode_akses"];
